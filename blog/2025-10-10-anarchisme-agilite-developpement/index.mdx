...
En plus du craftmanship, on voit arriver de plus en plus "la mode" des méthodes agiles.
La ou on part en mode autoroute avec le cycle en V, avec de grandes chances de se planter en explosant le budget,
...
À chaque fois qu'un personne arrive ou qu'une personne part, l'équipe change et devra se réadapter.
