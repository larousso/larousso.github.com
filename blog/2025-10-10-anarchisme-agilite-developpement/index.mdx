...
import premiercontact from './img/premiercontact.png'
...
<img src={premiercontact} width="800" />
...
Ces labels indépendants garantissent aux groupes une totale liberté de composition, de cadence etc contrairement au major pour lesquels le groupe est vu comme un produit.

De la même manière, il existe des distros, généralement un gars dans son garage qui vend vinyles, CD ou cassette en VPC.
