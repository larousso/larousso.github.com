...
Dans les années 2000, j'avais vu le groupe [sleeping in gethsemane](https://sigband.bandcamp.com/album/burrows) à Nantes au fouloir qui était un squat.
...
Parmi les groupes que j'ai écoutés, on peut citer [Refused](https://fr.wikipedia.org/wiki/Refused), [AFI](https://fr.wikipedia.org/wiki/AFI_(groupe)), [Propagandhi](https://fr.wikipedia.org/wiki/Propagandhi) ou encore [Raein](https://raeinband.bandcamp.com/) et [Yage](https://yageandersleben.bandcamp.com/album/some-time-of-a-time) qui sont des portes paroles de ce mouvement.

Certains groupes comme [Propagandhi](https://propagandhi.com/) vont encore plus loins, Anticapitaliste, Féministe, Végan, Pro LGBTQ+ etc, ils défendent les libertés de chacun et font la promotion d'auteurs, d'historiens et de médias activistes comme à l'époque Howard Zinn, Noam Chomsky, etc.
