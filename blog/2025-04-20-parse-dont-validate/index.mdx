...
Dans les langages fonctionnels tel que java ou haskell, il est d'usage d'utiliser au maximum le compilateur pour éviter le plus tôt possible les bugs.
...
L'approche "parse don't validate" rend le code bien plus robuste mais a un coût de mise en oeuvre.
A vous de choisir à quel niveau vous voulez utilisez cette approche !