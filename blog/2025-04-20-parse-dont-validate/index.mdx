...
Il faudra également être vigilent lors des évolutions car il se pourrait qu'en ajoutant des contraintes supplémentaires dans son code, on ne puisse plus relire nos données stockées en base.
