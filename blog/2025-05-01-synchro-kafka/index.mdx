...
#### La gestion des erreurs à l'épreuve du feu !

Même si le pattern de gestion des erreurs semble bien, en production on peut avoir des surprises !
Faire un retry infini quand c'est une erreur "non recoverable" peut avoir des conséquences désastreuses !
...
Pour le moment, pour éviter d'impacter trop fortement les consommateurs lors de mises à jour de masses, nous avons choisi d'étaler sur de très longues périodes les reprises de données. Par exemple 50 mise à jour toutes les 3 secondes, et ce, pour 2 semaines de traitement.
